...
\begin{subfigure}[t]{0.58\linewidth}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      % --- ENVS data-efficiency sweep (red): %data * 138 GPU-h
      %       30% -> 41.4  GPU-h, pass@8 = 27.0
      %       60% -> 82.8  GPU-h, pass@8 = 29.3
      %       75% -> 103.5 GPU-h, pass@8 = 30.7
      %      100% -> 138.0 GPU-h, pass@8 = 30.3  (headline ENVS)
      \addplot[color=red!55!black, line width=0.7pt, mark=none, densely dashed]
        coordinates {(41.4,27.0) (82.8,29.3) (103.5,30.7) (138,30.3)};
      \addplot[mark=*, mark size=1.8pt, color=red!75!black, only marks]
        coordinates {(41.4,27.0) (82.8,29.3) (103.5,30.7) (138,30.3)};

      % --- Improvement arrow: ARPO-clean -> ENVS-75% (Pareto-dominant point)
      \draw[-{Stealth[length=4.5pt, width=4pt]},
            line width=0.9pt, green!42!black]
        (axis cs:175,26.95) -- (axis cs:113,30.00);
      \node[font=\scriptsize\bfseries, text=green!35!black, anchor=north]
        at (axis cs:115,28.1) {$1.8\times$ less compute};
...
\textbf{(a)} Each marker is a trained policy at pass@8 on the 300-task clean \textsc{OSWorld} pool; $x$-axis is training compute in A100 GPU-hours. The red curve traces \textsc{ENVS}'s data-efficiency sweep at $30/60/75/100\%$ of collected trajectories. At $75\%$ data, \textsc{ENVS} reaches $30.7$ vs.\ ARPO's $26.7$ at $\sim$$1.8\times$ less compute, and already matches ARPO with only $30\%$ of its data.}
\label{fig:teaser}
\end{figure}
